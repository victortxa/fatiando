# -*- coding: utf-8 -*-
#
# Fatiando a Terra documentation build configuration file, created by
# sphinx-quickstart on Tue May 22 15:17:01 2012.
#
...
html_title = 'Fatiando a Terra v%s' % (version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Fatiando a Terra v%s' % (version)
...
latex_documents = [
  ('index', 'fatiando-%s.tex' % (version), u'User and developer guide',
   u'Leonardo Uieda', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'img/latex-logo.png'
...
man_pages = [
    ('index', 'fatiando', u'Fatiando a Terra Documentation',
     [u'Leonardo Uieda'], 1)
]
...
texinfo_documents = [
  ('index', 'FatiandoaTerra', u'Fatiando a Terra Documentation',
   u'Leonardo Uieda', 'FatiandoaTerra', 'One line description of project.',
   'Miscellaneous'),
]
